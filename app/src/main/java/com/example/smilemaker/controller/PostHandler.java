...
public class PostHandler extends SQLiteOpenHelper {
    ...
    public static final String DB_NAME = "smile";
    ...
    public void EditPost(String jokeId, String joke, Context context) {
        try {// on below line we are creating a variable for
            ...
            values.put(CONTENT_COL, joke);

            // after adding all values we are passing
            // content values to our table.
            db.update(WALLPOST_TBL, values, WID_COL + "=?", new String[]{jokeId});
//            db.update(WALLPOST_TBL, null, values);
